...
Send, {Tab}
Pause
Send, {Enter}{Tab 2}%month_number% Ren Q 1st Reminder Sent{Tab 2}q{Enter}
Sleep 300
Send, !av
Pause ;here you click the + to open a new note
Send, 1st reminder sent
Pause ;here you would add any additional notes needed
Send, {Tab}{Enter}
Sleep 200
Send, {F4}
Pause ;need to update the follow up date before closing
Send, !{F4}
Return
...
Send, {Tab}
Pause
Send, {Enter}{Tab 2}%month_number% Ren Q 2nd Reminder Sent{Tab 2}q{Enter}
Sleep 300
Send, !av
Pause ;here you click the + to open a new note
...
Sleep 100
Send, !{F4}
Pause ;this is where you drag over the email just sent into the client's attachments. ensure the cursor is on the 'attach to' line
Send, {F4}
Sleep 300
Send, {Tab}
Pause
Send, {Enter}{Tab 2}%month% Ren Q 3rd Reminder Sent{Tab 2}q{Enter}
Sleep 300
Send, !av
Pause ;here you click the + to open a new note
